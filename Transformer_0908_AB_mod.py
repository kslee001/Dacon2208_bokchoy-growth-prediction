'''
        1. Import libraries
'''
print("[ bi-directional model ] \n")
model_name = "model_0908_AB_mod"
model_states_name = "model_0908_AB_mod_states"
...
make_directory("/home/gyuseonglee/DS_practice_AB/"+model_name+"_folder")
torch.save(best_model.state_dict(), "/home/gyuseonglee/DS_practice_AB/"+model_name+"_folder/"+model_name)
torch.save(best_model, "/home/gyuseonglee/DS_practice_AB/"+model_name+"_folder/"+model_states_name)
...
for i in range(6):
    with torch.no_grad():
        ...
        PATH = "/home/gyuseonglee/DS_practice_AB/"+model_name+"_folder/TEST_0{i+1}.csv"
